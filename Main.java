            ...
            if(input.length() > 0) {
                ...
                switch (splited[0].substring(1)) {
                    case "read":
                        ...
                        if(articlesContext.getArticles() == 1){
                            examContext.setCurrentState(new CanTakeTestState());
                        }
                        else {
                    ...
                    case "exam":
                        if(splited.length == 1){
                            ...
                            if (articlesContext.getArticles() > 0) {
                            ...
                            else if(!(examContext.getCurrentState() instanceof CanTakeTestState)){
